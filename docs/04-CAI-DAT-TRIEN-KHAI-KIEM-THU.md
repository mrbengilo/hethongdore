...
- Migration: `drizzle/0000_dore_initial.sql`.
...
- Công thức thưởng tại các ngưỡng biên.
- Phụ cấp TikTok không ghi trùng.
- Điều chuyển hết hạn tự thu hồi quyền.
...
- [ ] Hoàn thiện các bảng dữ liệu mục tiêu còn dùng dữ liệu trình diễn.
