...
const storeMenu = ["Tá»•ng quan", "Ca lÃ m viá»‡c", "Lá»‹ch phÃ¢n ca", "NhÃ¢n viÃªn", "Nháº­p hÃ ng", "Chi phÃ­ cá»‘ Ä‘á»‹nh", "Cháº¥m cÃ´ng", "LÆ°Æ¡ng thÆ°á»Ÿng", "ÄÆ¡n hÃ ng", "DÃ²ng tiá»n", "BÃ¡o cÃ¡o", "CÃ i Ä‘áº·t"];
const employeeMenu = ["Trang chá»§", "ÄÆ¡n hÃ ng", "Báº£ng lÆ°Æ¡ng", "DÃ²ng tiá»n", "Lá»‹ch sá»­ ca lÃ m"];
const menuIcons: Record<string, LucideIcon> = { "Tá»•ng quan": LayoutDashboard, "Cá»­a hÃ ng": Store, "Giao viá»‡c": ClipboardCheck, "DÃ²ng tiá»n": WalletCards, "LÆ°Æ¡ng thÆ°á»Ÿng quáº£n lÃ½": BadgeDollarSign, "BÃ¡o cÃ¡o": BarChart3, "Äiá»u chuyá»ƒn nhÃ¢n sá»±": UsersRound, "Cá»• tá»©c": PieChart, "CÃ i Ä‘áº·t": Settings, "Ca lÃ m viá»‡c": CalendarDays, "Lá»‹ch phÃ¢n ca": CalendarRange, "NhÃ¢n viÃªn": UserRound, "Nháº­p hÃ ng": PackageOpen, "Chi phÃ­ cá»‘ Ä‘á»‹nh": ReceiptText, "Cháº¥m cÃ´ng": Clock3, "LÆ°Æ¡ng thÆ°á»Ÿng": BadgeDollarSign, "ÄÆ¡n hÃ ng": ShoppingCart, "Trang chá»§": Home, "Báº£ng lÆ°Æ¡ng": BadgeDollarSign, "Lá»‹ch sá»­ ca lÃ m": History };
